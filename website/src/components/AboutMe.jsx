...
const AboutMe = () => {
    return (
        <div id="AboutMe" className="max-w-[1400px] m-auto md:pl-4 p-4 py-16">
            ...
            <div className="md:max-w-2xl mx-auto xl:max-w-6xl px-10 py-10 md:py-8 md:px-0">
                ...
                <div className="md:flex pt-6">
                    ...
                    <div className="mt-4 h-full flex-1 w-full md:mt-0 bg-white rounded-2xl md:p-6 p-4 shadow-lg leading-snug ">
                        <h1 className="text-2xl font-semibold text-primary pl-4 py-2 pr-4">Hello!</h1>
                        <p className="text-base pl-4 pr-4 ">
                            Welcome to my little corner of the internet!<br></br><br></br>
                            I'm Lisa Liu, a Software Engineering student at the University of Waterloo, graduating in 2026.<br></br><br></br>
                            ...
                            ranging from User Experience Developer to Front-end Engineering.<br></br><br></br>
            ...
            <div>
                <div>
                    <h2 className="text-2xl font-bold text-center text-[#001b5e]">
                        Programming Languages
                    </h2>
                    <ProgrammingIcons/>
                </div>
                <div>
                    <h2 className="text-2xl font-bold text-center text-[#001b5e] pt-2">
